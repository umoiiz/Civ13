...
//head
	...
	to_chat(world, "<big><b>[H.real_name]是英国领主!</b></big>")
...
//head
	...
	H.equip_to_slot_or_del(new /obj/item/weapon/material/sword/broadsword(H), slot_back)
	H.equip_to_slot_or_del(new /obj/item/weapon/shield/steel(H), slot_l_hand)
	to_chat(world, "<big><b>[H.real_name]是法国领主!</b></big>")
	H.add_note("Role", "You are a <b>[title]</b>, the absolute Lord of this army. Organize your men!")
	H.setStat("strength", STAT_MEDIUM_HIGH)
	H.setStat("crafting", STAT_NORMAL)
	H.setStat("rifle", STAT_NORMAL)
...
//head
	...
	to_chat(world, "<big><b>[H.real_name]是埃米尔!</b></big>")
...
//head
	...
	to_chat(world, "<big><b>[H.real_name]是波希米亚领主!</b></big>")
...
//head
	...
	to_chat(world, "<big><b>[H.real_name]是波希米亚侍从!</b></big>")
