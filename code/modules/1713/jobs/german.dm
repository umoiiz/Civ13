...
//weapons
	...
	give_random_name(H)
	to_chat(world, "<big><b>[H.real_name]是德国部队的上尉!</b></big>")
...
//weapons
	...
	uniform.attackby(holsterh, H)
	give_random_name(H)
	to_chat(world, "<big><b>[H.real_name]是德国部队的中尉!</b></big>")
...
//weapons
	...
	uniform.attackby(holsterh, H)
	give_random_name(H)
	to_chat(world, "<big><b>[H.real_name]是德国部队的少尉!</b></big>")
	H.add_note("Role", "You are a <b>[title]</b>, an officer in charge of the troops and their orders. The whole operation relies on you!")
	H.setStat("strength", STAT_MEDIUM_HIGH)
	H.setStat("crafting", STAT_NORMAL)
	H.setStat("rifle", STAT_NORMAL)
...
//weapons
	...
	uniform.attackby(holsterh, H)
	give_random_name(H)
	to_chat(world, "<big><b>[H.real_name]是德国部队的指挥官!</b></big>")
