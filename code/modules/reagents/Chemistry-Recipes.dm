...
datum/admins/proc/print_chemical_reactions()
	...
	if (choice == "Wiki")
		...
		to_chat(recipe_list, "! 结果")
		to_chat(recipe_list, "! 成分")
		to_chat(recipe_list, "! 催化剂")
		to_chat(recipe_list, "! 抑制剂")
		to_chat(recipe_list, "! 产出量")
...
/datum/chemical_reaction/nitroglycerin/on_reaction(var/datum/reagents/holder, var/created_volume)
	...
	if (created_volume >= 20)
		for (var/mob/living/human/H in range(exloc,3))
			to_chat(H, "<big><span class = 'red'>该试剂开始剧烈燃烧,哦不...</span></big>")
		spawn(30)
