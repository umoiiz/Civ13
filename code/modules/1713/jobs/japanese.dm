...
//weapons
	...
	to_chat(world, "<big><b>[H.real_name]是日本部队的队长!</b></big>")
...
//weapons
	...
	if (H.f_style != "Shaved" && H.f_style != "Short Facial Hair" && H.f_style != "Goatee")
		H.f_style = pick("Shaved","Short Facial Hair","Goatee")
	to_chat(world, "<big><b>[H.real_name]是日本部队的第一中尉!</b></big>")
...
//weapons
	...
	if (H.f_style != "Shaved" && H.f_style != "Short Facial Hair" && H.f_style != "Goatee")
		H.f_style = pick("Shaved","Short Facial Hair","Goatee")
	to_chat(world, "<big><b>[H.real_name]是日本部队的第二中尉!</b></big>")
...
//weapons
	...
	H.equip_to_slot_or_del(KC, slot_wear_id)
	give_random_name(H)
	to_chat(world, "<big><b>[H.real_name]是日本部队的营地主任!</b></big>")
...
//weapons
	...
	if (H.f_style != "Shaved" && H.f_style != "Short Facial Hair" && H.f_style != "Goatee")
		H.f_style = pick("Shaved","Short Facial Hair","Goatee")
	to_chat(world, "<big><b>[H.real_name]是日本部队的中尉!</b></big>")
...
//weapons
	...
	if (H.f_style != "Shaved" && H.f_style != "Short Facial Hair" && H.f_style != "Goatee")
		H.f_style = pick("Shaved","Short Facial Hair","Goatee")
	to_chat(world, "<big><b>[H.real_name]是日本部队的少尉!</b></big>")
...
//weapons
	...
	if (H.f_style != "Shaved" && H.f_style != "Short Facial Hair" && H.f_style != "Goatee")
		H.f_style = pick("Shaved","Short Facial Hair","Goatee")
	to_chat(world, "<big><b>[H.real_name]是日本部队的准尉!</b></big>")
