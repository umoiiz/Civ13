...
//head
	...
	to_chat(world, "<big><b>[H.real_name]是法国海军舰船的舰长!</b></big>")
...
//head
	...
	H.equip_to_slot_or_del(new /obj/item/weapon/material/sword/spadroon(H), slot_belt)
	to_chat(world, "<big><b>[H.real_name]是法国海军舰船的舵手长!</b></big>")
...
//head
	...
	H.equip_to_slot_or_del(new /obj/item/weapon/attachment/scope/adjustable/binoculars(H), slot_l_store)
	H.equip_to_slot_or_del(new /obj/item/weapon/material/sword/spadroon(H), slot_belt)
	to_chat(world, "<big><b>[H.real_name]是法国海军舰船的水手长!</b></big>")
...
//weapons
	...
	give_random_name(H)
	to_chat(world, "<big><b>[H.real_name]是法国部队的队长!</b></big>")
...
//weapons
	...
	uniform.attackby(holsterh, H)
	give_random_name(H)
	to_chat(world, "<big><b>[H.real_name]是法国部队的第一中尉!</b></big>")
...
//weapons
	...
	uniform.attackby(holsterh, H)
	give_random_name(H)
	to_chat(world, "<big><b>[H.real_name]是法国部队的第二中尉!</b></big>")
	H.add_note("Role", "You are a <b>[title]</b>, an officer in charge of the troops and their orders. The whole operation relies on you!")
	H.setStat("strength", STAT_MEDIUM_HIGH)
	H.setStat("crafting", STAT_NORMAL)
	H.setStat("rifle", STAT_NORMAL)
